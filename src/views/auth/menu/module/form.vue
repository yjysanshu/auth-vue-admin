  ...
  <el-dialog :append-to-body="true" :visible.sync="dialog" :title="isAdd ? '新增菜单' : '编辑菜单'" width="600px">
    <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
      ...
      <el-form-item v-if="form.iframe === '0'" label="组件路径">
        <el-input v-model="form.component" :disabled="form.id && form.id <= 14" placeholder="菜单路径" style="width: 460px;"/>
      </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      form: { name: '', sort: 999, path: '', component: '', iframe: 'false', roles: [], pid: 0, icon: '' }, roleIds: [1],
      rules: {
        name: [
